...
| **Smart Valuation of Pre-Owned Cars Using ML** | Python, scikit-learn, pandas, NumPy, seaborn, Matplotlib | Developed and compared Decision Tree, Random Forest, Extra Trees, and Bagging regressors to predict used car prices with 89% accuracy using feature engineering and ensemble learning. | [View Repo](https://github.com/your-username/smart-valuation-used-cars-ml) |
